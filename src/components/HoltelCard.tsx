...
const ItemCard: React.FC<ItemCardProps> = ({ type, hotel, service, experience }) => {
  ...
  return (
    <div className="flex flex-col gap-[11px] items-start bg-transparent sm:bg-white md:bg-white lg:bg-transparent xl:bg-transparent rounded-[26px] shadow-none sm:shadow-lg md:shadow-lg lg:shadow-none xl:shadow-none w-full h-full p-[16px] ">
      {/* Carousel container */}
