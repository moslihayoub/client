...
const ItemCard: React.FC<ItemCardProps> = ({ id, type, hotel, service, experience, health, onClick }) => {
      ...
      <button onClick={onClick} className="w-full">
        <div className="flex flex-col gap-[14px] sm:gap-[20px] md:gap-[14px] lg:gap-[14px] xl:gap-[14px] items-start w-full">
          ...
          <div className="flex flex-col gap-[2px] sm:gap-[10px] md:gap-[2px] lg:gap-[2px] xl:gap-[2px] items-start w-full">
            <h2 className="text-[14px] sm:text-[20px] md:text-[16px] lg:text-[14px] xl:text-[16px] font-semibold text-start font-weight-600 text-slate-800 leading-[20px] font-bricolagegrotesque">
              {title}
            </h2>
            <p className="text-[14px] sm:text-[20px] md:text-[16px] lg:text-[14px] xl:text-[16px] font-normal text-slate-600 leading-[20px] font-vendsans font-weight-400 text-start">
          ...
          {/* Health contact info */}
          {type === 'Health' && (
            <div className="flex gap-[6px] items-start w-full mb-2">
              {/* Contactez Button */}
              <button className="flex-1 bg-emerald-500 rounded-xl px-[15px] py-[6px] flex items-center justify-center gap-[4px] cursor-pointer hover:opacity-90 transition-opacity">
                <p className="text-[16px] font-bricolagegrotesque font-medium leading-[24px] text-white whitespace-nowrap">
                  Contactez
                </p>
              ...
              {/* Localisé Button */}
              <button
                className="flex-1 rounded-xl px-[15px] py-[6px] flex items-center justify-center gap-[4px] cursor-pointer hover:opacity-90 transition-opacity"
                style={{
