  ...
  return (
    <div className='flex flex-col gap-3 items-start justify-center w-full'>
        ...
        <div className='flex flex-row items-start justify-start gap-2 overflow-x-auto scrollbar-hide w-full'>
            {cards.map((card) => (
                <div key={card.title} className='flex flex-col gap-2 flex-shrink-0 w-[220px]'>
                    <img src={card.image} alt={card.title} className='w-full h-[134px] object-cover justify-center rounded-[12px]' />
