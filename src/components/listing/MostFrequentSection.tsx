...
interface MostFrequentSectionProps {
...
function MostFrequentSection({ type, items, distance, count }: MostFrequentSectionProps) {
  ...
  return (
    <div className="w-full flex flex-col gap-[8px]">
      <div className="flex items-center justify-between w-full">
        ...
        <div className="flex gap-[6px] items-center">
          <p className="text-base font-semibold font-bricolagegrotesque text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-sky-500 leading-[24px]">
            Moins {distance}
          </p>
          <div className="rounded-[6px] px-[8px] py-[4px] bg-gradient-to-r from-teal-400 to-sky-500">
            ...
            return (
              <button
                ...
                className={`transition-all duration-300 rounded-full ${
                  pageIndex === index
                    ? "w-[40px] h-[10px] bg-sky-500"
                    : "w-[10px] h-[10px] bg-slate-300"
                }`}
              />
            );
          })}
...
export default MostFrequentSection;
