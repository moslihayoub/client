        ...
        {items.map((item) => (
          ...
          >
            <div className="rounded-[31px] bg-white border border-slate-200 p-[12px] flex flex-col gap-[14px] h-full" style={{ minHeight: '280px' }}>
              ...
              <div className="flex flex-col gap-[6px] items-start flex-1 min-h-0 overflow-hidden">
                <p className="text-xl font-bold font-bricolagegrotesque text-slate-800 leading-[32px] w-full truncate">
                  {item.title}
                </p>
                <p 
