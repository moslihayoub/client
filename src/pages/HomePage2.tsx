            ...
            <div className="z-10 flex flex-col h-full fixed w-full">
                    ...
                    <div className="flex flex-row items-center justify-center gap-[72px] w-full">
                        ...
                        <div className='flex flex-col gap-[18px] justify-center items-center w-[559px] h-[335px]'>
                            <div className='flex flex-col justify-center items-center'>
                                <p className="font-bricolagegrotesque font-semibold text-[48px] text-center text-slate-950 leading-[64px]">Votre logement idéal!</p>
                                <p className="font-vendsans font-medium text-[24px] text-center leading-[36px] text-slate-950">Découvrez notre marketplace intelligente</p>
                            </div>
                ...
                <div className="md:hidden flex flex-col items-center justify-center mt-[20%] gap-[18px] h-full w-full ">
                    ...
                    <div className={`flex flex-col justify-center items-center transition-all duration-500 ${mobileFullscreen ? 'blur-sm' : ''}`}>
                        ...
                        <p className="font-vendsans font-medium text-[18px] text-center leading-[28px] text-slate-900">Découvrez notre marketplace intelligente</p>
                    </div>
                    ...
                    <div className={`flex-1 flex items-start justify-center w-full px-4 pb-24 transition-all duration-500 ${mobileFullscreen ? 'blur-sm' : ''}`}>
                        <div className="w-full h-[78%] overflow-hidden rounded-[30px] bg-transparent flex items-start justify-center">
                            <img
