...
import Cards from '@/features/Social/Cards'
import MobileSearchbar from '@/features/Marketplace/MobileSearchbar'
import BgLottie from '@/features/Home/BgLottie'
        ...
        >
            ...
            <div className={`relative z-30 flex flex-col min-h-screen w-full ${fullscreen ? "blur-md" : ""}`}>
                ...
                <div className="flex-1 w-full px-2 sm:px-4 py-6 md:px-6 md:pb-32 md:py-0 flex flex-col items-center justify-start md:justify-center">
                    <div className="w-full max-w-7xl mx-auto flex flex-col gap-8 md:gap-[12px] items-center mt-[20%] mb-[40%] md:mt-[1%] md:mb-0">
                        {/* Header Section */}
                        <div className="flex flex-col items-center text-center w-full">
                            <h1 className="text-[30px] sm:text-3xl md:text-[36px] font-semibold text-slate-950 font-bricolagegrotesque leading-[40px] mb-0">
                                Votre logement idéal sur NexaStay!
                            </h1>
                            <p className="text-[18px] font-medium text-slate-900 font-vendsans leading-[28px] md:leading-[24px] mt-0">
            ...
            {!isMobileMenuOpen && (
                <div className={`fixed rounded-[22px] z-30 bottom-0 left-0 h-[23%] w-[30%] sm:w-full md:w-[50%] flex items-end justify-center p-4 mx-0 md:mx-[25%] transition-all duration-500 ease-in-out bg-gradient-to-b from-transparent sm:from-[24.52%] to-transparent backdrop-blur-[1px] ${isMobile ? 'mb-[50px]' : ''} `}
